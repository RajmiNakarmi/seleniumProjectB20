...
//shortcut to introduce local variables is Atl+enter

        // locating all the links in the page and storing them into a List of WebElements
...
int numbersOfLinks = listOfLinks.size();
        System.out.println("numberOfLinks = "+ numbersOfLinks);
